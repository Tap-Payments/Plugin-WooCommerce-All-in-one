...
function tap_init_gateway_class() {
    ...
    // 				$woocommerce->cart->add_to_cart( $product_id, $product_quantity, $product_variation_id , $variationName);
 		...
 		public function tap_checkout_receipt_page($order_id) {
 			...
 			// $Secrect_Key = $this->private_key;

 			// $Currency = $order->currency;
 			 $Post_Url = $this->post_url;

 			// $Hash = 'x_publickey'. $Public_Key.'x_amount'.'10.00'.'x_currency'.$Currency.'x_transaction'.$ref.'x_post'.$Post_Url;
    //         $hashstring = hash_hmac('sha256', $Hash, $Secrect_Key);
            //echo $Hash;exit;
            ...
            //var_dump($ServerNotificationUrl);exit;
